# -*- coding: utf-8 -*-
"""
Created on Wed Jul  8 15:29:12 2020
...
if __name__ == "__main__":
    ...
    ResNet_classify_path = os.path.join(ResNet_Pretrained_path, 'DNN.ckpt')
    ...
    List_Num = np.array(table.col_values(0))[Malig_ind_all]
    Class = np.array(table.col_values(3))[Malig_ind_all]
    ...
    LiHaiMing_data = xlrd.open_workbook('../Test/LiHaiMing_Task2.xls')
...
#    LiHaiMing_predict = [1 if i=='是' else 0 for i in LiHaiMing_predict]
    LiHaiMing_predict = (np.array(LiHaiMing_score)>3).astype(int)
    ...
    WangShengPing_data = xlrd.open_workbook('../Test/WangShengPing_Task2.xls')
    ...
    WangShengPing_predict = [1 if i=='yes' else 0 for i in WangShengPing_predict]
    ...
    ZhuHui_data = xlrd.open_workbook('../Test/ZhuHui_Task2.xls')
    ...
    WangTingTing_data = xlrd.open_workbook('../Test/WangTingTing_Task2.xls')
    ...
    WangTingTing_predict = (np.array(WangTingTing_score)>3).astype(int)
    ...
    HuTingDan_data = xlrd.open_workbook('../Test/HuTingDan_Task2.xlsx')
    ...
    HuTingDan_predict = (np.array(HuTingDan_score)>3).astype(int)
    ...
    LiMengLei_data = xlrd.open_workbook('../Test/LiMengLei_Task2.xlsx')
    ...
    LiMengLei_predict = (np.array(LiMengLei_score)>3).astype(int)
